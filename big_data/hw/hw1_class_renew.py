...
class calculator:
    global name_score_dict
    global subject_score_dict
    def __init__(self):
    ...
    def horizon_info(self):
        ...
        for i in list(name_score_dict.keys()):
            ...
            average = round(summation / len(subject_score_dict), 1)
            data = i + temp + ': ' + str(summation) + '  ' + str(average) + '\n'
            f.write(data)
        line = '=' * 25 + '\n'
        f.write(line)
